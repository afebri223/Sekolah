            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.users.update', $user) }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 {{ $user->role === 'guru' ? '' : 'display: none;' }}" id="wali-kelas-section">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_wali_kelas" name="is_wali_kelas" 
                                       value="1" {{ old('is_wali_kelas', $user->is_wali_kelas) ? 'checked' : '' }}>
                                <label class="form-check-label" for="is_wali_kelas">
                                    Jadikan sebagai Wali Kelas
                                </label>
                            </div>
                            @if($user->waliKelas)
                            <small class="text-muted">Saat ini wali kelas: {{ $user->waliKelas->name }}</small>
                            @endif
                        </div>
                    </div>
